     ...
     //   TextView email;
        ...
        public ViewHolder(View itemView,int ViewType) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                textView = (TextView) itemView.findViewById(R.id.navTitle); // Creating TextView object with the id of textView from item_row.xml
                imageView = (ImageView) itemView.findViewById(R.id.navIcon);// Creating ImageView object with the id of ImageView from item_row.xml
             ...
             //   email = (TextView) itemView.findViewById(R.id.email);       // Creating Text View object from header.xml for email
                profile = (ImageView) itemView.findViewById(R.id.imageView2);// Creating Image view object from header.xml for profile pic
